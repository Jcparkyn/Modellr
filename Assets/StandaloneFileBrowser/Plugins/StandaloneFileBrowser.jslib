var StandaloneFileBrowserWebGLPlugin = {
    ...
    UploadFile: function(gameObjectNamePtr, methodNamePtr, filterPtr, multiselect) {
		...
		//console.log("Recieved request params");
        ...
        fileInput.onchange = function (event) {
            ...
            unityInstance.SendMessage(gameObjectName, methodName, URL.createObjectURL(event.target.files[0]));

            // Remove after file selected
            document.body.removeChild(fileInput);
        }
        document.body.appendChild(fileInput);
		//console.log("Appended fileInput");
		fileInput.click();
    ...
    DownloadFile2: function(gameObjectNamePtr, methodNamePtr, filenamePtr, byteArray, byteArraySize) {
